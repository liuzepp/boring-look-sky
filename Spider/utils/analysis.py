...
class Analysis():
    ...
    def jsonfenxi(self, city_name):
        ...
        file_name = "G:\\毕业设计\\Spider\\csvfile\\" + city_name + ".csv"
        ...
        file_path = "G:\\毕业设计\\Spider\\jsonfile\\" + city_name + ".json"
        ...
        line_chart.render_to_file("G:\\毕业设计\\Spider\\analysisfile\\"+ city_name + '租房价格分析.svg')